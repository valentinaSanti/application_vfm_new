...
abstract class DistancesDao {
 ...
 @Query('SELECT value FROM Distance WHERE dateTime between :startTime and :endTime ORDER BY dateTime ASC')
Future<List<double?>> DataDistance(DateTime startTime, DateTime endTime);
